...
api.interceptors.request.use(
    (config)=>{
        ...
        const openRoutes=["/api/user/v1/login", "/api/user/v1/signup", "/api/user/v1/changePassword", "/api/user/v1/getOTP", "/api/user/v1/sendOTP", "/api/user/v1/google", "/api/user/v1/sendResetOTP", "/api/admin/v1/login"]
