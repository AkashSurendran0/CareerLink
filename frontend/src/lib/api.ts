...
const apiGatewayRoute = process.env.NEXT_PUBLIC_API_GATEWAY_ROUTE || 'http://localhost:5000'
const frontedRoute = process.env.NEXT_PUBLIC_FRONTEND_ROUTE || 'http://localhost:3000'
