    ...
    return (
        <div className="min-h-screen w-7xl bg-gray-50">
            <div className="max-w-8xl mx-auto p-4 md:p-6 lg:p-8">
                {/* Header */}
                <div className="mb-8">
                    <h1 className="text-4xl font-bold text-gray-900 mb-2">Add New Plan</h1>
                </div>
                    ...
                    <div>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <button
                                ...
                                className={`relative inline-flex h-7 w-12 items-center rounded-full transition-colors ${formData.active ? "bg-blue-500" : "bg-gray-300"
                                    }`}
                            >
                                <span
